...
class LinkTagsToItem(MethodView):
    ...
    def post(self, item_id, tag_id):
        ...
        item = ItemModel.query.get_or_404(item_id, description="item error")
        tag = TagModel.query.get_or_404(tag_id, description="tag error")
...
class Tag(MethodView):
    ...
    @blp.response(
        202,
        description="Deletes an item in no item is tagged with it.",
